...
- **Worldforged section** — Items with `@Worldforged` flavor text are grouped under Equipment → Worldforged (AdiBags_Ascension filter). Mythic+ is sorted into its own category; uncollected appearances go to Transmog.
